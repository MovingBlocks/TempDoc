...
Components may only contain specific data types - this is used to support persistence. These types<a name="component-data-types" class="anchor" href="#component-data-types"/> are:
