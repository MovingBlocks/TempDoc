...
* If you end up with heap size errors, you should add the VM option `-Xmx1024m` in the run configuration. (it will allow Java to use up to 1024m for the heap).  In IntelliJ that's the "Run" menu, "Run..." dialog, "Edit Configurations".  There's a "VM options" on the right.
